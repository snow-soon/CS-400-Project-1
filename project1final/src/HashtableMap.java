...
// Lecture #: 002 @2:30pm
// Notes to Grader: I blindly followed my past project from CS300 which also used linked lists,
// however it did not use the "java.util.LinkedList" so I hope my project is fine without using it
